...
def load_data(file_path):
    ...
    data = pd.read_csv(file_path).values  # Read data from CSV file
    x_data = data[:, :-1]  # Features are all columns except the last
    y_data = data[:, -1]  # Labels are in the last column
